...
export const ImageUplaodModal = () => {
    const {isOpen, onClose, type} = useModal();
    const router  = useRouter();
    
    const isModalOpen = isOpen && type === "imageUpload"
...
const onSubmit = async(values:z.infer<typeof formSchema>) => {
    try{
        await axios.post("/api/uploadimage", values);
...
export default ImageUplaodModal;